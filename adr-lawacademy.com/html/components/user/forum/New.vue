        ...
        <template v-for="item in post">
          ...
          >
            ...
            <v-list-item-content>
              ...
              <div class="tw-flex">
                <div class="author-name tw-block tw-mr-1 tw-text-[#858585]">
              ...
              <div class="tw-flex tw-flex-col">
                <div class="tw-flex tw-flex-between tw-mt-1 tw-cursor-pointer tw-w-3/5 tw-cursor-pointer" @click="fdetailForum(item._id)">
                ...
                <div class="tw-flex tw-flex-row tw-mt-2">
                  ...
                  <a>
                    <v-icon small color="#858585" class="tw-mr-2 tw-cursor-pointer" @click="fdetailForum(item._id)">
                      mdi-comment-outline
                    </v-icon>
                  </a>
...
export default {
  ...
  async fetch () {
    const res = await this.$axios.$get('forum/data')
    this.post = res.data
  },
  computed: {

          ...
          <div class="tw-px-12 tw-pb-4">
            ...
            <div v-show="show">
              ...
              <div class="tw-flex tw-flex-col tw-px-3 tw-py-3">
                <div v-if="content_type_id == '1'">
                  <video width="950" height="550" controls :src="url" />
                </div>
                <div v-if="type_name == 'image'">
                  <v-img
                    class="tw-mx-3 my-3 tw-cursor-pointer"
                ...
                <span>Nama file: <a :href="url" target="_blank">{{ originalname }}</a></span>
              </div>
            </div>
            <div v-show="show_url">
              <v-card-title class="tw-text-h5">
            ...
            <div v-show="show_quiz">
              <div class="tw-flex tw-flex-row tw-items-center">
                ...
                <div id="id_step1_2" class="tw-ml-2 tw-cursor-pointer" style="color: #146EB4" @click="changeStep(true, false)">
                  Pengaturan Quiz
                </div>
                ...
                <div id="id_step2_2" class="tw-ml-2 tw-cursor-pointer" style="color: #C2C2C2" @click="changeStep(false, true)">
                  Isi Konten
                </div>
              </div>
              ...
              <div v-show="step1">
                ...
                <div class="tw-grid tw-grid-cols-3 tw-px-3 tw-py-3">
                  ...
                  <div class="tw-col-span-2">
                    <select v-model="is_commentary" disabled class="tw-w-full tw-form-select">
                ...
                <div class="tw-grid tw-grid-cols-3 tw-px-3 tw-py-3">
                  ...
                  <div class="tw-col-span-2">
                    <select v-model="remidial_type" class="tw-w-full tw-form-select" disabled @change="changeremidial">
                      <option selected disabled value="null">
                        Pilih
                      </option>
                ...
                <div class="tw-grid tw-grid-cols-3 tw-px-3 tw-py-3">
                  ...
                  <div class="tw-col-span-2">
                    <select v-model="is_skip" disabled class="tw-w-full tw-form-select">
                      <option selected disabled value="null">
                        Pilih
                      </option>
                      <option value="true">
                ...
                <div class="tw-grid tw-grid-cols-3 tw-px-3 tw-py-3">
                  ...
                  <div class="tw-col-span-2">
                    <select v-model="is_show_result" disabled class="tw-w-full tw-form-select">
                      <option selected disabled value="null">
                        Pilih
                      </option>
                      <option value="true">
                    ...
                    <v-expansion-panel v-for="(question, index) in questions" :key="index" expand>
                      ...
                      <v-expansion-panel-content>
                        <div class="tw-grid tw-grid-cols-3 tw-py-2">
                          ...
                          <div class="tw-col-span-2">
                            <select v-model="question.question_type" disabled class="tw-w-full tw-form-select">
                              <option selected disabled value="null">
                                Pilih
                              </option>
                              <!-- <option value="1">
                        ...
                        <div class="tw-grid tw-grid-cols-3 tw-py-2">
                          ...
                          <div class="tw-col-span-2">
                            <select v-model="question.attachment_type" disabled class="tw-w-full tw-form-select" @change="changeAttachment">
...
export default {
  ...
  async mounted () {
    ...
    this.topic_name = res3.data.topic.name
    this.description = res3.data.description
    this.content_type_id = res3.data.content_type_id
    this.content_type_name = res3.data.type.name
    this.url = res3.data.url
    ...
    const getQuizType = res2.data.data.filter(obj => obj.id == this.quiz_type).map(obj => ({ id: obj.id, name: obj.name }))
    this.quiz_type_name = getQuizType.length > 0 ? getQuizType[0].name : null
  ...
  methods: {
    ...
    async submitSettingQuiz () {
      const data = {
        ...
        assessment_weight: this.assesment_weight,

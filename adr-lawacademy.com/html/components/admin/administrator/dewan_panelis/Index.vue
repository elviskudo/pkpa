      ...
      >
        <template #top>
          ...
          <!-- <v-toolbar
            flat
          >
            <v-toolbar-title>Dewan Panelis</v-toolbar-title>
            <v-divider
              class="tw-mx-4"
              inset
              vertical
...
export default {
  ...
  methods: {
    async initialize () {
      const res = await this.$axios.$get('/user/user-dewan')
      this.desserts = res.data
    },
    viewItem (item) {
      this.$router.push(`/dashboard/admin/administrator/dewan-panelis/view/${item.id}`)
    },
    editItem (item) {
      this.$router.push(`/dashboard/admin/administrator/dewan-panelis/edit/${item.id}`)
    },
    ...
    add () {
      this.$router.push('/dashboard/admin/administrator/dewan-panelis/add')
    }
  }
}
</script>

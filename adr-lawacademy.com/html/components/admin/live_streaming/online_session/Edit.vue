          ...
          <v-form>
            <div class="tw-grid tw-grid-cols-3 tw-px-3 tw-py-3">
              ...
              <div class="tw-col-span-2">
                <select v-model="university_id" class="tw-w-2/3 tw-form-select" @change="getPhaseUniversity">
            ...
            <div class="tw-grid tw-grid-cols-3 tw-px-3 tw-py-3">
              ...
              <div class="tw-col-span-2">
                <select v-model="course_id" name="course" class="tw-form-select tw-w-2/3">
                  <option selected disabled value="null">
                    Pilih
                  </option>

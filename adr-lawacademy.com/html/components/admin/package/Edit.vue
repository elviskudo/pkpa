                    ...
                    <v-expansion-panel-content>
                      <div class="tw-grid tw-grid-cols-3 tw-py-2">
                        ...
                        <div class="tw-col-span-2">
                          <select v-model="item.id" name="state" class="tw-form-select tw-w-full" @change="getcontentTopic(index, item.id)">
...
export default {
  ...
  async mounted () {
    ...
    const currMt = await this.$axios.$get(`bank-course/${this.matakuliah_id}`)
    ...
    this.matakuliah.push(currMt.data)

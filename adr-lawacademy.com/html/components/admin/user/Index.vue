...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Universitas', value: 'univ_name' },
  ...
  async mounted () {
    ...
    if (this.loggedInUser.university_id) {
      ...
      const res = await this.$axios.$get(`student/?university_id=${this.university_id}`)
  ...
  methods: {
    ...
    async getPhaseUniversity () {
      const resx = await this.$axios.$get(`student/?university_id=${this.university_id}`)
      this.users = resx.data.data
    ...
    async getdataPhase () {
      const res = await this.$axios.$get(`student/?university_id=${this.university_id}&phase_id=${this.phase_id}`)
      this.users = res.data.data
    },
    viewItem (item) {
      this.$router.push(`/dashboard/admin/user/view/${item.user_id}`)
    },
    editItem (item) {
      this.$router.push(`/dashboard/admin/user/edit/${item.user_id}`)
    },

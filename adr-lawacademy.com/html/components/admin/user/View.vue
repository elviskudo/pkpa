<template>
  ...
  <v-card class="tw-mx-auto tw-mt-2 tw-ml-2 tw-mr-2 tw-justify-center">
    ...
    <div class="tw-flex tw-flex-col tw-mb-2">
      <div class="tw-px-12">
        <p class="tw-font-bold tw-text-lg tw-mb-6">
          Informasi Umum
        </p>
        <div class="md:tw-flex md:tw-items-center tw-mb-6">
          <div class="md:tw-w-1/3">
            <label class="block tw-text-gray-500 tw-font-bold md:tw-text-left tw-mb-1 md:tw-mb-0 tw-pr-4" for="inline-fullname">
              Nama Lengkap
            </label>
          </div>
        ...
        <div v-for="file in files" :key="file.id">
          <div class="md:tw-flex md:tw-items-center tw-mb-6">
            <div class="md:tw-w-1/3">
              ...
              <img class="tw-w-12 tw-h-12" :src="file.url">
            </div>
            <div class="md:tw-w-2/3">
              <!-- <div>
              <label class="tw-inline-flex tw-items-center">
                <input v-if="file.status == 'verified'" id="checkBoxId" type="checkbox" :value="file.id" checked>
                <input v-else id="checkBoxId" type="checkbox" :value="file.id">
        ...
        <div class="tw-flex tw-justify-center tw-items-center tw-mb-2">
          <button class="tw-w-full tw-rounded tw-bg-blue-600 tw-p-2 tw-text-white" @click="$router.back()">
            Kembali
          </button>
        <!-- <button class="tw-rounded tw-bg-red-600 tw-p-2 tw-text-white" @click="execute('rejected')">
          Tolak
        </button>
        <button

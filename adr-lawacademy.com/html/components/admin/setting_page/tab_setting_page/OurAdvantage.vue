        ...
        >
          <v-expansion-panel-header>
            ...
            >
              ...
              <v-card>
                <v-card-title>
                  <span class="text-h5">Edit Keunggulan PKPA ADR</span>
                </v-card-title>
                <v-divider />
                <v-card-text>
                  <div class="tw-px-12">
                    <div class="md:tw-flex md:tw-items-center tw-mb-6">
                      ...
                      <div class="md:tw-w-2/3">
                        <select v-model="label" name="state" class="tw-form-select tw-w-full">
                          <option selected value="Keunggulan PKPA ADR">
                            Keunggulan PKPA ADR
                          </option>
                        </select>
                        <input
...
export default {
  ...
  async mounted () {
    const res = await this.$axios.$get('/homepage/?section_name=Keunggulan PKPA ADR')
    console.log(res)

    ...
    <v-card>
      <div class="tw-flex tw-flex-col tw-mb-2">
        <div class="tw-px-12 tw-pb-4">
          ...
          <div class="tw-col-span-2">
            <select v-model="category_id" name="category" class="tw-form-input tw-w-2/3" disabled @change="changeCategory">
              <option selected disabled value="null">
                Pilih
              </option>
            ...
            <div class="tw-grid tw-grid-cols-3 tw-px-3 tw-py-3">
              ...
              <div v-for="(item, index) in tempCourses" :key="index" class="tw-col-span-2">
                <div class="tw-flex tw-flex-row">
                  <select v-model="item.course_id" name="course" class="tw-form-select tw-w-2/3" disabled>
                    <option selected disabled value="null">
                      Pilih
                    </option>
                  ...
                  <v-icon class="tw-ml-2" disabled @click="tempCourses.splice(index, 1)">
                    mdi-trash-can
                  </v-icon>
                </div>
              </div>
...
export default {
  ...
  async mounted () {
    ...
    // const res3 = await this.$axios.$get(`phase-university/?university_id=${this.university_id}`)
